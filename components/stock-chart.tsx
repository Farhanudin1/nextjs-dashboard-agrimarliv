...
export default function StockChart({ selectedYear = "2025" }: { selectedYear?: string }) {
  ...
  useEffect(() => {
    ...
    const initializeChart = () => {
      try {
        ...
        // Function to zoom to a specific year
        ...
        // Initial zoom to the selected year
        zoomToYear(Number.parseInt(selectedYear))
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      if (window.am4core && window.am4themes_animated) {
